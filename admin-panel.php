      ...
      <tbody>
        ...
        while ($row = mysqli_fetch_array($result)) {
          ...
          <tr>
            ...
            <td>
              <a href='update-community.php?un=$row[username]&sp=$row[spec]&em=$row[email]&pw=$row[password]'>
                <input type='submit' value='Update' class='btn btn-primary'>
              </a>
              <a href='delete-community.php?email=$row[email]'>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        stateSelect.addEventListener('change', function () {
            ...
            citySelect.innerHTML = '<option value="" disabled selected>Select City</option>'; // Clear existing options
